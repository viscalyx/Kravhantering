...
test('the certificate profile defines the settled trust and bundle contract', async () => {
...
test('the profile rejects server identity fallbacks and dual-purpose leaves', async () => {
