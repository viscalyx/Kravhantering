// THROWAWAY #1351. Reuses existing services; never seeds or migrates data.
...
const controlPath = `/tmp/krav-prototype-1351-${createHash('sha256').update(process.cwd()).digest('hex').slice(0, 12)}.sock`
...
const env = {
  ...
  AUTH_SESSION_COOKIE_NAME: 'prototype_1351_session',
  NEXT_PUBLIC_SITE_URL: 'http://localhost:3001',
  NEXT_PUBLIC_PROTOTYPE_1351: 'true',
  PROTOTYPE_1351: 'true',
}
...
console.log('Before/after gallery: http://localhost:3135')
console.log(
  'Read-only preview. 0=baseline, A=compact stack, B=full-width tabs, C=shared shelf. Ctrl+C stops both servers.',
)
const gallery = spawn(
  'python3',
  [
