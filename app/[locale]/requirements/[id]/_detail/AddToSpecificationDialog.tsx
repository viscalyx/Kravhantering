...
interface AddToSpecificationDialogProps {
  dialog: UseAddToSpecificationDialogResult
  onDocumentKeyDown: (event: KeyboardEvent<HTMLDivElement>) => void
}

export default function AddToSpecificationDialog({
  dialog,
  onDocumentKeyDown,
}: AddToSpecificationDialogProps) {
      ...
      {state.isOpen ? (
        ...
        >
          ...
          >
            ...
            {state.addToSpecificationStatus === 'success' ? (
                ...
                <div className="flex gap-3 pt-1">
                  <button
                    ...
                    disabled={
                      ...
                      state.addToSpecificationStatus === 'loading'
                    }
                    type="submit"
                  >
                    {state.addToSpecificationStatus === 'loading'
