---
applyTo: "{docs/security-privacy/informationsmangder-kravhantering.md,docs/informationssakerhetskrav-atgarder-app.md,docs/governance/admin-center.md,docs/development/database-schema.md,lib/typeorm/**/*.ts,typeorm/migrations/**/*.mjs,typeorm/seed*.mjs,lib/archiving/**/*.ts,app/api/admin/archiving/**/*.ts,app/[locale]/admin/**/*.tsx,tests/unit/archiving-retention*.test.ts}"
---
