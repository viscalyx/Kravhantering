      ...
      >
        ...
        >
          ...
          <div className="flex items-center justify-between border-b border-secondary-200 px-6 py-4 dark:border-secondary-700">
            ...
            <button
              aria-label={tc('close')}
              className="rounded-lg p-1.5 text-secondary-500 transition-colors hover:bg-secondary-100 hover:text-secondary-700 dark:text-secondary-400 dark:hover:bg-secondary-800 dark:hover:text-secondary-200"
              onClick={handleClose}
              type="button"
            >
          ...
          <div className="flex-1 overflow-y-auto px-6 py-4">
            ...
            <div className="space-y-4">
              ...
              <div>
                <button
                  className="flex min-h-11 min-w-11 items-center gap-1 text-sm text-primary-600 hover:text-primary-700 dark:text-primary-400 dark:hover:text-primary-300"
                  disabled={inProgress}
                  ...
                  <div className="mt-2 space-y-3">
                    <div>
                      <div className="mb-1 flex items-center justify-between">
                        ...
                        <button
                          className="flex min-h-11 min-w-11 items-center gap-1 text-xs text-primary-600 hover:text-primary-700 dark:text-primary-400 dark:hover:text-primary-300"
                          onClick={() =>
                      ...
                      {helpPanel('customInstructionHelp', 'customInstruction')}
                      {showDefaultInstruction && (
                        <pre className="mb-2 max-h-48 overflow-y-auto whitespace-pre-wrap rounded-lg border border-secondary-200 bg-secondary-50 p-3 text-xs text-secondary-700 dark:border-secondary-700 dark:bg-secondary-800/50 dark:text-secondary-300">
                    ...
                    <div>
                      ...
                      {showSystemPrompt && (
                        <pre className="mt-1 max-h-48 overflow-y-auto whitespace-pre-wrap rounded-lg border border-secondary-200 bg-secondary-50 p-3 text-xs text-secondary-700 dark:border-secondary-700 dark:bg-secondary-800/50 dark:text-secondary-300">
            ...
            {phase === 'done' && requirements.length > 0 && (
              <div className="mt-4 space-y-3">
                ...
                <div className="flex items-center gap-2">
                  <button
                    className="min-h-11 min-w-11 text-sm text-primary-600 hover:text-primary-700 dark:text-primary-400 dark:hover:text-primary-300"
                    onClick={toggleAll}
                    type="button"
                  >
                ...
                <div className="space-y-2">
                  {requirements.map((req, i) => (
                    <div
                      ...
                      key={`req-${req.description.slice(0, 40)}`}
                    >
          ...
          <div className="flex items-center justify-between border-t border-secondary-200 px-6 py-4 dark:border-secondary-700">
            <div className="flex gap-2">
              {inProgress ? (
                <button
                  className="min-h-11 rounded-lg border border-secondary-300 px-4 py-2 text-sm font-medium text-secondary-700 transition-colors hover:bg-secondary-50 dark:border-secondary-600 dark:text-secondary-300 dark:hover:bg-secondary-800"
            ...
            <div className="flex gap-2">
              {phase === 'done' && requirements.length > 0 && (
                <button
                  className="min-h-11 rounded-lg bg-primary-600 px-4 py-2 text-sm font-medium text-white transition-colors hover:bg-primary-700 disabled:opacity-50 dark:bg-primary-500 dark:hover:bg-primary-600"
