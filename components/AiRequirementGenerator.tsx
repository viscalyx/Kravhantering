        ...
        >
          ...
          >
            ...
            <div className="flex items-center justify-between border-b border-secondary-200 px-6 py-4 dark:border-secondary-700">
              ...
              <button
                aria-label={tc('close')}
                className="flex min-h-11 min-w-11 items-center justify-center rounded-lg p-1.5 text-secondary-500 transition-colors hover:bg-secondary-100 hover:text-secondary-700 disabled:opacity-50 dark:text-secondary-400 dark:hover:bg-secondary-800 dark:hover:text-secondary-200"
                disabled={creating}
                onClick={handleClose}
                {...devMarker({
                  context: 'ai-requirement-generator',
