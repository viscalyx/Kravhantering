...
const requirementDetailCardClassName =
  'prototype-detail-card relative flex-1 min-w-0 rounded-2xl border bg-white/80 p-6 text-sm shadow-sm backdrop-blur-sm space-y-5 dark:bg-secondary-900/60'
