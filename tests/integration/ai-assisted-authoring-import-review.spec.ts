...
test('AI-assisted authoring hands library candidates to requirement import review', async ({
  page,
}) => {
...
test('AI-assisted authoring hands kravunderlag candidates to local import review', async ({
  page,
}) => {
  await mockAiAuthoring(page)
  const preview = await mockImportPreview(
