...
const DEFAULT_USERS: Record<string, MockUser> = {
  ...
  SpecificationCoauthor: {
    sub: 'mock-specco-sub',
    given_name: 'Signe',
    family_name: 'SpecCoAuthor',
    name: 'Signe SpecCoAuthor',
    email: 'signe.speccoauthor@example.test',
    preferred_username: 'signe.speccoauthor',
    employeeHsaId: 'SE5560000001-specco1',
    roles: [],
  },
  PackageLead: {
    sub: 'mock-pkglead-sub',
    given_name: 'Leo',
    family_name: 'PackageLead',
    name: 'Leo PackageLead',
    email: 'leo.pkglead@example.test',
    preferred_username: 'leo.pkglead',
    employeeHsaId: 'SE5560000001-pkglead1',
    roles: [],
  },
  PackageCoauthor: {
    sub: 'mock-pkgco-sub',
  ...
  PrivacyOfficer: {
    sub: 'mock-privacy-sub',
    given_name: 'Disa',
    family_name: 'PrivacyOfficer',
