...
describe('AI generation availability MCP payload grid', () => {
  ...
  it('accepts exact MCP validation-session quota boundaries and rejects one-over values', () => {
    ...
    expect(isValidMcpImportMaxActiveSessionsPerDestination(1)).toBe(true)
    expect(isValidMcpImportMaxActiveSessionsPerDestination(1_000)).toBe(true)
    expect(isValidMcpImportMaxActiveSessionsPerDestination(0)).toBe(false)
    expect(isValidMcpImportMaxActiveSessionsPerDestination(1_001)).toBe(false)
    expect(isValidMcpImportMaxCreationsPerWindow(1)).toBe(true)
    expect(isValidMcpImportMaxCreationsPerWindow(200)).toBe(true)
    expect(isValidMcpImportMaxCreationsPerWindow(0)).toBe(false)
