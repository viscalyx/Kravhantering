const UP_STATEMENTS = [
  ...
  'CREATE TABLE [specification_local_requirement_requirement_packages] (\n  [specification_local_requirement_id] int NOT NULL,\n  [requirement_package_id] int NOT NULL,\n  CONSTRAINT [pk_specification_local_requirement_requirement_packages] PRIMARY KEY ([specification_local_requirement_id], [requirement_package_id])\n);',
  'CREATE TABLE [requirement_version_requirement_packages] (\n  [requirement_version_id] int NOT NULL,\n  [requirement_package_id] int NOT NULL,\n  CONSTRAINT [pk_requirement_version_requirement_packages] PRIMARY KEY ([requirement_version_id], [requirement_package_id])\n);',
  ...
  'CREATE INDEX [idx_specification_local_requirement_requirement_packages_requirement_package_id] ON [specification_local_requirement_requirement_packages] ([requirement_package_id]);',
  'CREATE INDEX [idx_requirement_version_requirement_packages_requirement_package_id] ON [requirement_version_requirement_packages] ([requirement_package_id]);',
...
const DOWN_STATEMENTS = [
  "IF OBJECT_ID(N'requirement_version_requirement_packages', N'U') IS NOT NULL DROP TABLE [requirement_version_requirement_packages];",
  "IF OBJECT_ID(N'specification_local_requirement_requirement_packages', N'U') IS NOT NULL DROP TABLE [specification_local_requirement_requirement_packages];",
