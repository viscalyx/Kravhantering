...
const UP_STATEMENTS = [
  ...
  'ALTER TABLE [requirement_version_requirement_packages] ADD CONSTRAINT [fk_requirement_version_requirement_packages_requirement_package_id] FOREIGN KEY ([requirement_package_id]) REFERENCES [requirement_packages] ([id]) ON DELETE CASCADE ON UPDATE NO ACTION;',
