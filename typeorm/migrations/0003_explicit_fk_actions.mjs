...
const UP_STATEMENTS = [
  ...
  "IF EXISTS (SELECT 1 FROM sys.foreign_keys WHERE name = N'fk_specification_local_requirement_usage_scenarios_specification_local_requirement_id') ALTER TABLE [specification_local_requirement_usage_scenarios] DROP CONSTRAINT [fk_specification_local_requirement_usage_scenarios_specification_local_requirement_id];",
  'ALTER TABLE [specification_local_requirement_usage_scenarios] ADD CONSTRAINT [fk_specification_local_requirement_usage_scenarios_specification_local_requirement_id] FOREIGN KEY ([specification_local_requirement_id]) REFERENCES [specification_local_requirements] ([id]) ON DELETE CASCADE ON UPDATE NO ACTION;',
  ...
  "IF EXISTS (SELECT 1 FROM sys.foreign_keys WHERE name = N'fk_specification_local_requirement_usage_scenarios_usage_scenario_id') ALTER TABLE [specification_local_requirement_usage_scenarios] DROP CONSTRAINT [fk_specification_local_requirement_usage_scenarios_usage_scenario_id];",
  'ALTER TABLE [specification_local_requirement_usage_scenarios] ADD CONSTRAINT [fk_specification_local_requirement_usage_scenarios_usage_scenario_id] FOREIGN KEY ([usage_scenario_id]) REFERENCES [usage_scenarios] ([id]) ON DELETE NO ACTION ON UPDATE NO ACTION;',
