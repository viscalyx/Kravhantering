...
The latest trusted public scan found zero affected observations for this
...
comments. The issue is closed as completed and can reopen if public findings
return before monitoring ends.
