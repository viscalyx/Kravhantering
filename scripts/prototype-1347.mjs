...
probe.once('error', () => {
  console.error(
    'Port 3003 is occupied. Reuse the running #1347 preview or stop it before restarting.',
  )
  process.exit(1)
})
probe.listen(port, '127.0.0.1', () =>
  probe.close(async () => {
    ...
    const clientId = 'kravhantering-prototype-1347'
    const clientSecret = 'dev-only-prototype-1347-secret'
    ...
    const prototypeEnv = {
      ...process.env,
      NEXT_PUBLIC_PROTOTYPE_1347: 'true',
      NEXT_PUBLIC_SITE_URL: 'http://localhost:3003',
      AUTH_OIDC_CLIENT_ID: clientId,
      AUTH_OIDC_CLIENT_SECRET: clientSecret,
      AUTH_OIDC_REDIRECT_URI: 'http://localhost:3003/api/auth/callback',
      AUTH_OIDC_POST_LOGOUT_REDIRECT_URI: 'http://localhost:3003/',
      AUTH_SESSION_COOKIE_NAME: 'prototype1347_session',
    }
