...
CREATE TABLE `requirement_type_categories` (
	`id` integer PRIMARY KEY AUTOINCREMENT NOT NULL,
	`name_sv` text NOT NULL,
	`name_en` text NOT NULL,
...
--> statement-breakpoint
CREATE INDEX `idx_requirement_type_categories_requirement_type_id` ON `requirement_type_categories` (`requirement_type_id`);--> statement-breakpoint
CREATE INDEX `idx_requirement_type_categories_parent_category_id` ON `requirement_type_categories` (`parent_category_id`);--> statement-breakpoint
...
CREATE TABLE `requirement_version_scenarios` (
	`requirement_version_id` integer NOT NULL,
	`requirement_scenario_id` integer NOT NULL,
	PRIMARY KEY(`requirement_version_id`, `requirement_scenario_id`),
	FOREIGN KEY (`requirement_version_id`) REFERENCES `requirement_versions`(`id`) ON UPDATE no action ON DELETE no action,
	FOREIGN KEY (`requirement_scenario_id`) REFERENCES `requirement_scenarios`(`id`) ON UPDATE no action ON DELETE no action
);
--> statement-breakpoint
CREATE TABLE `requirement_versions` (
	...
	`requirement_type_category_id` integer,
	...
	FOREIGN KEY (`requirement_type_id`) REFERENCES `requirement_types`(`id`) ON UPDATE no action ON DELETE no action,
	FOREIGN KEY (`requirement_type_category_id`) REFERENCES `requirement_type_categories`(`id`) ON UPDATE no action ON DELETE no action,
