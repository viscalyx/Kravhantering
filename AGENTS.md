...
- If you change visible UI elements, labels, or layout surfaces, also update the related Developer Mode help: `data-developer-mode-*` markers or scan heuristics, `docs/developer-mode-overlay.md`, and the relevant tests/instructions.
