...
| **Kravpaket** | Beskriver grupperingar där kravet hör hemma, till exempel mobil användning, datamigrering, integration med andra system, ärendehantering, användarvänlighet eller molndrift. Varje kravpaket har en ägare som ansvarar för kraven inom grupperingen. Att koppla kravpaket hjälper till att avgränsa kravunderlag och filtrera krav efter de paket som är relevanta för en viss leverans. |
