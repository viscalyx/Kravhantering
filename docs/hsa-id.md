...
Exempel: `SE5560000001-abc123` där `SE5560000001` HSA-id prefixet,
...
HSA-id prefix består av följande delar i angiven ordning:
...
HSA-id suffix består av valfria bokstäver (A-Z och a-z) och/eller siffror
(0-9). Tecknen `å`, `ä`, `ö` samt `@`-tecken är inte tillåtna.
