...
Namn och beskrivning får ändras utan ny verifiering. Modellrevisionen och
dess append-only verifieringsbevis sparas atomiskt.
Lyckad grundkontroll och minst en kompatibel körprofil krävs för sparande.
Oavgjorda valfria förmågor hindrar inte sparande men förblir otillgängliga.
Resonemangskraven och deras separata bevisgräns beskrivs i
...
konfigurationsversion som körningen startar med. En paus begär avbrott för
