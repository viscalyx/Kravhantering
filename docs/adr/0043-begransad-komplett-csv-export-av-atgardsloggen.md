...
Exporten förankrar medlemskapet vid det högsta rad-ID som finns när
genereringen börjar och läser därefter med nyckelbaserad sortering på
`occurred_at DESC, id DESC` under vanlig `READ COMMITTED`. Detta fryser
medlemskap och ordning utan en lång snapshot-transaktion; samtidig
dataskyddsradering kan därför fortfarande ändra personuppgifter i rader som
ännu inte har lästs. Interaktiv sidindelning och läsning för export förblir
