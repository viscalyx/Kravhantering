...
| Åtgärdslogg | Bevara spår av appens ändringar och nekade behörighetsförsök även när verksamhetsobjekt raderas. | Aktörens HSA-id och namn, åtgärd, mål, tidpunkt, beslut, request-id, klient-IP och begränsade händelsedetaljer. | Ja. Aktörsuppgifter och klient-IP kan identifiera personer. | Admin Center, administratörens CSV-export, personuppgiftsutdrag och SQL Server. | Ingen tidsstyrd gallring eller Admin Arkivering-policy finns. Dataskydd kan anonymisera eller byta aktörens HSA-id och namn, men bevarar loggraden och klient-IP. | Godkänt beslut om formell informationsägare, lagringstid eller undantag saknas. Förvaltningen behöver fatta beslutet. Plattformens beslut för Säkerhetslogg gäller inte automatiskt denna SQL-lagring. | [åtgärdslogg](./audit-log.md), [ADR 0018](../adr/0018-atgardsloggens-bevis-overlever-andringar-i-domandata.md), [personuppgiftsutdrag](./privacy-data-subject-access-export.md) |
| Identitet, session och säkerhetslogg | Säkerställa inloggning, behörighet, spårbarhet och säkerhetsuppföljning. | OIDC-claims, sessionstillstånd, roller, HSA-id, request-id, klient-IP, authhändelser, MCP-aktör och auditdetaljer. | Ja. Session och audit kan innehålla HSA-id, namn, roller, IP-adress och händelsedata. | OIDC-/IdP-tjänst, webb-UI, MCP-tokenvalidering, plattformsloggning, SIEM eller annan auditmottagare. | Fastställs av förvaltningen och driftplattformen. Applikationen skriver säkerhetslogg till loggström men äger inte loggplattformens retention. | Fastställs av förvaltningen och driftorganisationen. | [auth-beskrivning](./auth-how-it-works.md), [Admin Center](../governance/admin-center.md), [riskanalys](./riskanalys.txt) |
...
säkerhetsloggens metadata. Personuppgifterna avser anställda eller
...
- redigerad säkerhetslogg som inte ska bära hemligheter eller råa
...
gallring ger endast metadata i säkerhetslogg. Evidensdata, hemligheter och
...
Tiderna 365 och 730 dagar nedan är applikationens förvalda policyvärden.
Kontrollera den aktuella policyn och förvaltningens beslut före körning.
Verksamhetsbehov, revision och legal hold måste registreras som undantag
när de inte redan skyddas av applikationens urvalsvillkor. Raderna för
avvikelser, förbättringsförslag och behörighetsöversyner beskriver behov av
bevarande; de har inga egna körbara policyer i Admin Arkivering.
...
| Gamla kravversioner utan kravunderlagsberoende | När versionen är Arkiverad i minst 365 dagar, har varit i vanlig Granskning i minst 365 dagar eller har varit Utkast utan redigering i minst 365 dagar, och aldrig har kopplats till kravunderlag. | Radera versionen och dess kopplingar; radera kravet om inga versioner återstår. | Ingen kravunderlagsexport krävs eftersom versionen aldrig har kopplats till kravunderlag; kravtext som kan behöva historik ska inte matcha policyn. | Aktuell kravunderlagskoppling, tidigare kravunderlagshistorik, arkiveringsgranskning, aktivt arbete eller legal hold. | Förvaltning och dataskyddshandläggare. |
| Kravunderlag utanför förvaltning | När kravunderlaget inte har status `Förvaltning`, inte har uppdaterats på minst 730 dagar och saknar aktuella eller väntande avtal. | Radera kravunderlaget och dess lokala krav, behovsreferenser och kravunderlagskopplingar först efter exportbekräftelse. | Exportera anonymiserad JSON med metadata, behovsreferenser, lokala krav, kopplade bibliotekskrav, den kravunderlagskopplade kravversionens egenskaper, taxonomietiketter, paket, normreferenser och avvikelser. Bibliotekskrav raderas inte av denna policy. | Kravunderlag i `Förvaltning`, aktuella eller väntande avtal, pågående granskning/upphandling, aktivt uppdrag, dokumenterat verksamhetsbehov eller legal hold. | Förvaltning och dataskyddshandläggare. |
| Behörighetsöversyner | När översynen är slutförd/avbruten och beslutad lagringstid har passerat. | Ingen separat gallringspolicy finns i Admin Arkivering. | Exportera översynsbeviset med avidentifierade aktörsfält när personidentifiering inte längre behövs. | Årlig revision, pågående åtgärd, externa revisionskrav eller legal hold. | Förvaltning, säkerhetsfunktion och dataskyddshandläggare. |
| Åtgärdslogg | Ingen godkänd lagringstid är fastställd. | Ingen tidsstyrd gallring finns; radering av målobjekt raderar inte loggen. | Dataskydd ändrar endast aktörens HSA-id och namn. Klient-IP ingår inte i personuppgiftsutdrag eller dataskyddsradering. CSV-export är ingen gallringsbekräftelse. | Inget godkänt undantag från appstyrd gallring finns. | Förvaltningen behöver utse informationsägare och besluta om bevarande, gallring och eventuell export. |
| Säkerhetslogg och driftloggar | Fastställs av drift- och säkerhetsförvaltning utifrån spårbarhetskrav. | Hanteras i plattformsloggning/SIEM, inte av appens SQL-retention. | Appen ska inte skriva råa mål-HSA-id:n i loggar för gallring. | Incident, incidentutredning, revisionskrav och andra krav på loggbevarande. | Drift- och säkerhetsförvaltning. |
...
| Tidsbegränsad AI-forensisk evidensinsamling | 72 timmar efter manuellt stopp eller SQL-tidsstyrd utgång. | Schemalagd cleanup raderar evidens i begränsade batcher och markerar styrposten som gallrad. Privacy Officer kan gallra omedelbart; dataskyddsradering stoppar och gallrar matchande fönster samt exakta aktörsfingeravtryck. | Ingen Admin Arkivering-policy och ingen arkivexport. Detta är ett uttryckligt appnära gallringsundantag: den fasta säkerhetsgränsen får inte förlängas med legal hold i appen. Metadata-only säkerhetslogg kan finnas kvar enligt loggplattformens separata beslut. | Återläsning från backup får inte göra utgången evidens operativt åtkomlig; driftorganisationen måste återköra cleanup efter restore och låta backupkopior löpa ut enligt beslutad backupretention. | Säkerhetsförvaltning, Privacy Officer och driftorganisation. |
...
| Säkerhetslogg | Skriver strukturerade säkerhetshändelser till plattformsloggning. | Aktör, händelsetyp, request-id, klient-IP, beslut och redigerade detaljer. | Loggskydd, SIEM-routning, retention och behörighet till loggverktyg fastställs av drift- och säkerhetsförvaltning. |
<!-- markdownlint-enable MD013 -->
...
| Driftplattform, reverse proxy, loggning och SIEM | Runtime, TLS-terminering, hemlighetshantering, begärandeloggning och säkerhetslogg. | Trafikmetadata, driftloggar, säkerhetsloggar, sessionscookies i transit och miljöparametrar. | Plattformsägare, geografisk driftplats, loggretention, åtkomst till loggar/hemligheter, incidentväg och tekniska säkerhetskrav. |
...
5. Hantera Åtgärdsloggens ägarskap och retention som ett öppet
   förvaltningsbeslut: godkänd informationsägare och regel saknas. Besluta
   om lagringstid, gallring och eventuellt exportkrav eller dokumenterat
   undantag. Att implementationen bevarar loggraden är inte ett fastställt
   bevarandebeslut.
6. Granska underlaget vid större ändringar i Kravhantering och minst enligt
...
personens pågående arbeten har avslutats. Privilegierad radering återställer
återstående startkvot.
...
befintliga åtgärdsloggen och omfattas av dess dataskyddsflöde. Loggens
lagringstid och formella ägare behöver beslutas separat enligt matrisen ovan.
