...
godkända målarkitekturen. De blir operativa informationsmängder och komponenter
när den leverantörsneutrala migrationen är driftsatt.
...
| AI-assisterat författande | Stödja kravförfattare med förslag baserade på ämne, instruktioner, bilder och taxonomi. | AI-anropets ämne, bildinnehåll, taxonomival, AI-svar och användningsmetadata. | Ja, om användaren matar in personuppgifter eller sekretessbelagt material i text eller bild. | Webb-UI och den AI-leverantör eller agentmiljö som nås genom den administratörsgodkända AI-anslutningen, samt SQL Server om AI-svar sparas som kravinformation. | Fastställs av förvaltningen. AI-assisterat författande ska behandlas som stödflöde och inte som fristående långtidsarkiv. | Fastställs av förvaltningen. AI-anslutningens informationsklass, behandling, underleverantörer och retention ska attesteras före aktivering. | [AI-dokumentation](../governance/reference-data-and-ai.md), [ADR 0051](../adr/0051-ai-integrationslager-med-korprofiler-och-adaptrar.md), [ADR 0052](../adr/0052-tillitsgrans-och-krypterade-ai-leverantorshemligheter.md) |
| AI-anslutningskonfiguration och leverantörshemligheter | Styra godkända AI-anslutningar, anslutningsmodeller och körprofilrevisioner. | Anslutningsadress, attest, datapolicy, verifieringsbevis, förmågor, krypterad leverantörshemlighet och root-key-version. | Nej i avsedd strukturerad konfiguration; attestfält ska inte bära personuppgifter utöver organisatorisk kontakt där sådan krävs. | Admin Center, app-runtime och SQL Server; extern root-keyring distribueras separat till appnoderna. | Använda revisioner bevaras för audit. Gammal chiffertext raderas efter verifierad rotation och återkallad leverantörshemlighet; root-key-versioner bevaras så länge databasrader eller återställningsbara backuper behöver dem. | Produktadministratören äger anslutningskonfiguration och leverantörshemligheter. Driften äger root-keyring, distribution, backup och återställning. | [ADR 0052](../adr/0052-tillitsgrans-och-krypterade-ai-leverantorshemligheter.md), [driftrutin](../operations/ai-connections.md) |
...
| AI-integrationslager | Väljer administratörsstyrd körprofil och utför avgränsade AI-anrop genom en adapter. | AI-anropets text och bilder, fullständigt AI-svar, användningsmetadata och opaka spårnings-ID:n. | AI-anslutningar, anslutningsmodeller, förmågepolicy, säkerhetsgrindar och drifttelemetri styrs enligt ADR 0051 och ADR 0052. |
