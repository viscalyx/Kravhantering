...
| Fristående ägare utan aktiva uppdrag | När ägaren inte längre är kopplad till kravområden eller kravunderlag och beslutad lagringstid har passerat. | Radera ägarposten. | Ingen separat arkivpost i applikationen. | Ägare som fortfarande är kopplad till kravområden eller annan aktiv ansvarsyta. Ansvariga för kravpaket hanteras som direkta HSA-ID-/namnsnapshots på kravpaket, inte som ägarposter. | Dataskyddshandläggare. |
