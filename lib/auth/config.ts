 ...
 *
 * See `docs/security-privacy/auth-how-it-works.md`,
 * `docs/integrations/oidc-identity-provider-integration.md`, and
 * `docs/development/auth-developer-workflow.md` for the committed env-var
